...
public class UserService {
    ...
    public Map<String, Object> login(String username, String password, HttpSession request, Environment environment) throws UnsupportedEncodingException, NoSuchAlgorithmException, PasswordInvalidException {
